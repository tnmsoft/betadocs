...
![wdd-master-filter-single](/assets/images/dashboards/img124780.png)

The Master Filter item supports the following modes.
* **None** - Disables master filtering.
* **Multiple** - Allows you to select multiple elements in the Master Filter item. To reset filtering, use the **Clear Master Filter** button (the ![wdd-master-filtering-icon](/assets/images/dashboards/img125072.png) icon) in the dashboard item's caption.
...
![wdd-master-filter-cross-data-source](/assets/images/dashboards/img124783.png)
...
![wdd-master-filter-ignore](/assets/images/dashboards/img124782.png)